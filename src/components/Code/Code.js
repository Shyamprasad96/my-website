      ...
      <table class="table table-bordered is-bordered is-fullwidth is-rounded table-hover footable">
        <thead>
          <tr>
            ...
            <th><div class="text-center is-hidden-mobile table-text">Frequency</div></th>
            <th data-hide="phone,tablet"><div class="text-center table-text">Tag</div></th>
            <th><div class="text-center table-text">Code</div></th>
            <th data-hide="phone,tablet"><div class="text-center table-text">Link</div></th>
          </tr>
        </thead>
        <tbody>
          <tr>
